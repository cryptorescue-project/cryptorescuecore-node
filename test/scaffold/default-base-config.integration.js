...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    cryptorescued.spawn.datadir.should.equal(home + '/.cryptorescue');
    cryptorescued.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/cryptorescued'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.cryptorescued.spawn.datadir.should.equal('./data2');
  });
});
