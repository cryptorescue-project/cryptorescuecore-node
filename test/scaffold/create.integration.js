...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.cryptorescue', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/cryptorescuecore-node.json';
      ...
      config.services.should.deep.equal(['cryptorescued', 'db', 'address', 'web']);
