...
var cryptorescuecorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = cryptorescuecorenode.version;
  var create = cryptorescuecorenode.scaffold.create;
  var add = cryptorescuecorenode.scaffold.add;
  var start = cryptorescuecorenode.scaffold.start;
  var remove = cryptorescuecorenode.scaffold.remove;
  var callMethod = cryptorescuecorenode.scaffold.callMethod;
  var findConfig = cryptorescuecorenode.scaffold.findConfig;
  var defaultConfig = cryptorescuecorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the CryptoRescue database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `cryptorescuecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ cryptorescuecore-node add wallet-service');
      console.log('    $ cryptorescuecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ cryptorescuecore-node remove wallet-service');
      console.log('    $ cryptorescuecore-node remove insight-api');
      console.log();
    });
